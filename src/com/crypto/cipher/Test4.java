...
/**
 * create by toonew on 2018/8/30
 */
public class Test4 {

    public static void main(String[] args) throws Exception {
        String miwen = OpenSslAes.encrypt("1234567891123456", "Here is my string");
        System.out.println(miwen);

        String mingwen = OpenSslAes.decrypt("1234567891123456", miwen);
